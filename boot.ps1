<#
.SYNOPSIS
Boot script for new Windows installation.

.DESCRIPTION
Installs WinGet and dependencies if not already installed, and then Chezmoi to be able to boostrap a new device.
#>
